  ...
  return (
    <div className="standard-content">
      <p>
        ...
        and I've only ever camped at music festivals, but here I am, about to
        set off on a cycle trip from Land’s End to John o’Groats, camping along
        the way.
      </p>
      ...
      <p>
        ...
        "independent" (the company books your accommodation for you and plans
        your route, but you cycle by yourself).
      </p>
      ...
      <p>
        The <a target="_blank" href="https://www.cicerone.co.uk/why-cicerone-lejog-cycling-route-optimal-choice">Cicerone route</a> claims
        to be the "optimal" route - quiet roads where possible, busier roads
      ...
      <p>
        LEJOG is generally the preferred route among end-to-enders. As you’re
        cycling in a mostly northerly direction, the sun is behind you and out
        of your eyes, and the rumour is that the prevailing south-westerly wind
      ...
      <p>
        Finding campsites with availability in August was difficult, and many
        had 2-night minimum bookings (<a target="_blank" href="https://www.campsites.co.uk/search">campsites.co.uk</a> is
      ...
      <p>
        ...
        I was lucky enough to get a ballot spot for the <a target="_blank" href="https://www.ridelondon.co.uk/">RideLondon 100</a> last
        year, and bought a road bike especially for it (my other bike is a
        Dutch-style city bike, which I love for short local cycles but it's not
        suitable for RideLondon 100 or LEJOG). RideLondon 100 was unfortunately
        cancelled due to the Covid-19 pandemic, and while I've cycled my road
        bike around London and up Box Hill, it would be nice to get some more
        mileage out of it.
      </p>
      ...
      <p>
        <PostImageSingle
          caption="My bike on unboxing day last year"
          image="https://lauren-anders-blog.s3.eu-west-2.amazonaws.com/72db75a3-a0cf-4fd5-b46e-041642ec6da9_3"
        />
      </p>

      <p>
        I sent my bike off for a full service with <a target="_blank" href="https://www.havebike.co.uk/">HaveBike</a> a
      ...
      <p>
        ...
        uncomfortable. Saying that, I've only ever camped in cheap and
        definitely not waterproof festival tents. I've been promised many a
        time that <em>actual</em> camping is much more enjoyable, so I'm going
        into this with an open mind.
      </p>

      <p>
        Buying a legitimate, actually waterproof yet portable tent was something
        we didn't take lightly. A good hour was spent testing out the many options
        in Go Outdoors, eventually deciding on a 3-person Coleman tent with a
        little porch area, good waterproof rating and 10-minute assembly time.
        Certainly an improvement on my previous £8 1-man tents! We took the tent
        to <a href="https://www.valleyfest.co.uk/" target="_blank">Valleyfest</a> to
        test it out for the night. My first night in a proper tent and I actually
        had a good night’s sleep! Perhaps camping is for me after all.
      </p>

      <p>
        <PostImageSingle
          caption="Testing out the tent at Valleyfest (the outer is a bit off-centre!)"
          image="https://lauren-anders-blog.s3.eu-west-2.amazonaws.com/72db75a3-a0cf-4fd5-b46e-041642ec6da9_7"
          portrait
        />
      </p>
      ...
      <p>
        I knew I needed to get some practice with handling the weight and width
        the panniers will add to my bike. So I set off on a cycle a few days ago
        with some dumbbells in my panniers to add some weight. And it was
        raining! Another box ticked.
      </p>

      <p>
        <PostImageSingle
          caption="Braving the elements for a training cycle"
          image="https://lauren-anders-blog.s3.eu-west-2.amazonaws.com/72db75a3-a0cf-4fd5-b46e-041642ec6da9_5"
          portrait
        />
      </p>

      <p>
        While I was cycling down a contraflow cycle
        lane, I noticed a smashed glass bottle, but it was too late to do
        anything about it without swerving into oncoming traffic, so I had to
        cycle through it. I thought I’d managed to get away with it, but about
      ...
      <p>
        Taking a closer look at home, the damage was <em>bad</em>. A piece of
        glass had left a large hole in the sidewall of my tyre. I looked into my
        repair options, but with sidewall punctures, it is best to just
        completely replace the tyre. You can “boot patch” a hole in a tyre, but
        these only last for about 200km, and we have over 1,600km to cycle! Even
        if I replaced the boot patch every 200km, the risk of tyre blowouts is
        still quite high, and not worth the risk. I’m gutted because I love the
        yellow-rim road tyres on my bike and they’re now discontinued, but I
        know I do need something more practical and less puncture-prone for this
        trip.
      </p>
      ...
      <p>
        <PostImageSingle
          caption="The culprit"
          image="https://lauren-anders-blog.s3.eu-west-2.amazonaws.com/72db75a3-a0cf-4fd5-b46e-041642ec6da9_6"
        />
      </p>
      ...
      <p>
        <PostImageSingle
          caption="Points of interest along the way (Google Maps). I feel like I may have been a bit harsh on the Midlands/North West..."
          image="https://lauren-anders-blog.s3.eu-west-2.amazonaws.com/72db75a3-a0cf-4fd5-b46e-041642ec6da9_2"
          portrait
        />
      </p>
