...
const PostContent = (props) => {
  return (
    <>
      ...
      <p>
        The last couple of weeks of my internship were really fun, with leaving
        drinks and a leaving meal with my colleagues. There was even a sheep
      ...
      <p>
        <PostImageSingle
          caption="Sheep trying to get a job"
      ...
      <p>
        After a long drive to Merseyside (it turned out to be a seven-hour round
        trip for my stepdad who drove to pick me up), I have a few days at home
        ...
        everything I’d amassed in Malvern, and that was just from nine weeks
      ...
      <p>
        ...
        London, so I showed them the delights of Popworld. Face paint and animal
        masks were involved! Overall, an excellent send off.
      </p>
